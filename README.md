...
```bash
git clone https://github.com/YOUR_USERNAME/fmcg-ai-assistant.git
...
OPENAI_API_KEY=sk-...              # Required for Enrichment Agent embeddings
DB_STAGE=sqlite                    # Start with sqlite
```

### 5. Generate mock data and run

```bash
# Generate mock FMCG database
...
## Running the Delivery Interfaces
